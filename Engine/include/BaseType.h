...
// Classes present in the shipped SIF engine but absent from public PlaygroundOSS.
#define CLS_KLBUISCALE9BTN	(6 | CLS_KLBENGINECLASS | CLS_KLBUICORECLASS)
...
#define CLS_KLBSHADERTASK	(84| CLS_KLBUSERTASK)
#define CLS_KLBRENDERBUFFERTASK	(85| CLS_KLBUSERTASK | CLS_KLBENGINECLASS)
...
#define CLS_ASSETGRIDTEXTURE	(11| CLS_KLBASSETCLASS)
