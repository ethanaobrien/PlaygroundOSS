...
public:
    ...
    void detailedLogging(const char*, const char*, int, const char*, ...) override;
    ...
    IWidget* createControl(IWidget::CONTROL, int, const char*, int, int, int, int, ...) override;
    ...
    int encryptAES128CBC(unsigned char*, int, const char*, int, const char*, int) override;
    int decryptAES128CBC(unsigned char*, int, const char*, int, const char*, int) override;
    ...
    void addNetworkFormData(CurlObjectInternal*, const char*, long, const void*) override;
    void setupNetworkConnection(CurlObjectInternal*, const char*, const char*, void*, void*, void*, void*) override;
...
private:
    ...
    std::unordered_map<std::string, std::string> m_secureData;
};
