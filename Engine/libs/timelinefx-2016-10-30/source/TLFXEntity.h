...
namespace TLFX
{
    ...
    public:
         ...
         */
        float GetImageRadius() const { return _imageRadius; }
         ...
         */
        float GetEntityRadius() const { return _entityRadius; }
        ...
        bool UpdateSelected() { return (this->*_updateHandler)(); }
    ...
    protected:
        typedef bool (Entity::*UpdateHandler)();

        // Per-instance update dispatch allows derived entities to select their
        // update routine without adding an Update slot to the virtual table.
        ...
        // captured values used for render tweening
        float                           _oldX, _oldY;
        float                           _oldWX, _oldWY;
        float                           _oldZ;
