...
namespace TLFX
{
    ...
    public:
        ...
        bool Load(const char *buffer, unsigned int size, bool compile);
        ...
        static float GetLookupFrequencyOverTime() { return _lookupFrequencyOverTime; }
        static float GetLookupFrequencyOverTimeInverse() { return _lookupFrequencyOverTimeInverse; }
    ...
    protected:
        void Load(XMLLoader *loader, bool compile);
        ...
        static float                    _lookupFrequencyOverTimeInverse;
    };
