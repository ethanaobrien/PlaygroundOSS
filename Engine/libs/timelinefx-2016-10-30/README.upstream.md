...
RectangleBinPack provenance
---------------------------

The embedded `source/RectangleBinPack` files are from Jukka Jylänki's
public-domain RectangleBinPack repository at revision
`92ca96a0b40c01dca10e28e13ff49c76757f44e3`. The particle unity includes
`Rect.cpp` before `MaxRectsBinPack.cpp`, matching the original build's
translation-unit layout and allowing the containment predicate to be inlined
where used.
